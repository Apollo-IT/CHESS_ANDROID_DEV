...
public class SignFragment_amap extends BaseFragment implements View.OnClickListener, LocationSource, AMapLocationListener{
    //-- top shift
    ...
    public void onLocationChanged(AMapLocation amapLocation) {
        if (mListener != null && amapLocation != null) {
            if (amapLocation != null && amapLocation.getErrorCode() == 0){
                ...
                showCurrentLocationMarker(isFirstLocation);
                isFirstLocation = false;

                // get address string by using google api
                AppData.setCurrentPosition(new Position(amapLocation.getLatitude(), amapLocation.getLongitude()));
                AddressHelper.getAddress(getActivity(), amapLocation.getLatitude(), amapLocation.getLongitude(), new AddressHelper.Callback() {
                    @Override
