...
public class MonthYearPicker {
    ...
    private static final String[] PICKER_DISPLAY_MONTHS_NAMES = new String[] { "1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "10月", "11月", "12月" };
    ...
    public void build(int selectedMonth, int selectedYear, DialogInterface.OnClickListener positiveButtonListener,
        ...
        String[] yearArray = new String[MAX_YEAR - MIN_YEAR + 1];
        for (int i = MIN_YEAR; i <= MAX_YEAR; i++) {
            yearArray[i - MIN_YEAR] = i + "年";
        }
        yearNumberPicker.setDisplayedValues(yearArray);
