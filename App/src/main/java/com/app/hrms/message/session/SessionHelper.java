package com.app.hrms.message.session;
...
import com.app.hrms.message.session.action.SkechAction;
import com.app.hrms.message.session.activity.MessageHistoryActivity;
import com.app.hrms.message.session.extension.CustomAttachParser;
import com.app.hrms.message.session.extension.CustomAttachment;
import com.app.hrms.message.session.extension.StickerAttachment;
import com.app.hrms.message.session.search.SearchMessageActivity;
import com.app.hrms.message.session.viewholder.MsgViewHolderDefCustom;
import com.app.hrms.message.session.viewholder.MsgViewHolderSticker;
import com.app.hrms.message.session.viewholder.MsgViewHolderTip;
...
//            p2pCustomization.backgroundUri = "android.resource://com.app.hrms.message/drawable/bk"
...
//            p2pCustomization.backgroundUri = "android.resource://com.app.hrms.message/drawable/bk"
    ...
    private static SessionCustomization getTeamCustomization() {
        if (teamCustomization == null) {
            ...
            infoButton.iconId = R.mipmap.suc_oper;
