package com.app.hrms.message.team;
...
public class TeamCreateHelper {
     ...
     * 创建高级群
     */
    public static void createAdvancedTeam(final Context context, List<String> memberAccounts, String groupName) {

        String teamName = groupName;
//------adv team create------------------------
        DialogMaker.showProgressDialog(context, context.getString(com.netease.nim.uikit.R.string.empty), true);
        // 创建群
