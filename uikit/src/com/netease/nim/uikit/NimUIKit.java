...
public final class NimUIKit {
    ...
    private static Class treeActivityClass;
    public static void setTreeActivityClass(Class clazz){
        treeActivityClass = clazz;
    }
...
//        ContactSelectActivity.startActivityForResult(context, option, requestCode);
        ...
        Intent intent = new Intent(context, treeActivityClass);
        intent.putExtra("groupId", "");
        intent.putExtra("groupName", "1");
