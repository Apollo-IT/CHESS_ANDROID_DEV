...
public class PercentFormatter implements ValueFormatter, AxisValueFormatter {
    ...
    public PercentFormatter() {
        mFormattedStringCache = new FormattedStringCache.Generic<>(new DecimalFormat("###"));
        mFormattedStringCacheAxis = new FormattedStringCache.PrimFloat(new DecimalFormat("###,###,###"));
    }
